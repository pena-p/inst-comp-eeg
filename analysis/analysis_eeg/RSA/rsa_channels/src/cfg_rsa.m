...
cfg.location = 'Z:/paula/inst-comp-eeg/EEG/results/rsa_channels/';
...
% Indicate derivative path and condition identifier
for k = 1:8
...
% Indicate file names per condintion
...
%% BALANCED DATASETS:
if strcmp(cfg.analysis,'RSA_ctp')
