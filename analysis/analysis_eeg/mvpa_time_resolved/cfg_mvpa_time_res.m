...
% cfg.powenv.uplow = 'upper' - RESPONSE_Lect upper envelope.
% cfg.powenv.uplow = 'lower' - RESPONSE_Lect lower envelope.
...
% cfg.classmodel.method = 'da'  - Linear DiscrimRESPONSE_Lt Analysis.
...
% cfg.classmodel.kernel = 'linear' - DiscrimRESPONSE_Lt Analysis.
% cfg.classmodel.kernel = 'quadratic' - DiscrimRESPONSE_Lt Analysis.
